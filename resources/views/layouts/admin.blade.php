                ...
                <ul class="space-y-2 px-4">
                    ...
                    <li>
                        <a href="{{ route('mentor.pending') }}"
                            class="flex items-center px-4 py-3 text-gray-300 hover:bg-slate-700 hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('mentor.pending*') ? 'border-l-4 border-blue-500 bg-slate-700 text-white' : '' }}">
