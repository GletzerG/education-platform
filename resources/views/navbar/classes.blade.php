...
<body>
    ...
    <div class="classes-container">
        <div class="classes-content">
            <div class="page-header">
                ...
                <p class="page-subtitle">Pilih kelas yang sesuai dengan minat dan level kemampuan Anda. Dapatkan bimbingan dari mentor terbaik untuk mencapai tujuan belajar Anda.</p>
            </div>
            ...
            <div class="classes-grid" id="classesGrid">
                ...
                <div class="class-card" data-category="programming">
                    ...
                    <p class="class-description">Pelajari dasar-dasar JavaScript dari nol hingga mahir. Cocok untuk pemula yang ingin memulai karir sebagai web developer.</p>
                ...
                <div class="class-card" data-category="programming">
                    ...
                    <p class="class-description">Kuasai React.js untuk membangun aplikasi web modern. Pelajari hooks, context API, dan best practices.</p>
                    <div class="class-info">
                ...
                <div class="class-card" data-category="programming">
                    ...
                    <p class="class-description">Belajar analisis data dan machine learning menggunakan Python. Cocok untuk yang ingin berkarir di bidang data.</p>
                    <div class="class-info">
                ...
                <div class="class-card" data-category="design">
                    ...
                    <p class="class-description">Pelajari prinsip-prinsip design thinking dan cara membuat interface yang user-friendly.</p>
                    <div class="class-info">
                ...
                <div class="class-card" data-category="design">
                    ...
                    <p class="class-description">Kuasai Figma untuk membuat prototype dan design system yang profesional.</p>
                    <div class="class-info">
                        <div class="class-info-item">⏱️ 8 Minggu</div>
                        <div class="class-info-item">📚 24 Materi</div>
                ...
                <div class="class-card" data-category="marketing">
                    ...
                    <p class="class-description">Pelajari strategi pemasaran digital yang efektif untuk meningkatkan brand awareness dan penjualan.</p>
                    <div class="class-info">
                        <div class="class-info-item">⏱️ 6 Minggu</div>
                ...
                <div class="class-card" data-category="marketing">
                    ...
                    <p class="class-description">Optimalisasi media sosial untuk bisnis. Pelajari content planning, engagement, dan analytics.</p>
                    <div class="class-info">
                        <div class="class-info-item">⏱️ 8 Minggu</div>
                ...
                <div class="class-card" data-category="business">
                    ...
                    <p class="class-description">Panduan lengkap membangun startup dari ide hingga eksekusi. Cocok untuk calon entrepreneur.</p>
                    <div class="class-info">
                        <div class="class-info-item">⏱️ 10 Minggu</div>
                ...
                <div class="class-card" data-category="language">
                    ...
                    <p class="class-description">Tingkatkan kemampuan bahasa Inggris untuk dunia kerja. Focus pada business communication dan presentation skills.</p>
                    <div class="class-info">
                        <div class="class-info-item">⏱️ 12 Minggu</div>
                ...
                <div class="class-card" data-category="language">
                    ...
                    <p class="class-description">Pelajari bahasa Mandarin untuk keperluan bisnis. Cocok untuk yang ingin bekerja di perusahaan multinasional.</p>
                    <div class="class-info">
    ...
    <script>
        ...
        function addSearchFeature() {
            ...
            document.querySelector('.filter-tabs').parentNode.insertBefore(searchContainer, document.querySelector('.filter-tabs'));
