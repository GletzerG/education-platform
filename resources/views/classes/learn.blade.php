                ...
                <div class="learning-content">
                                    ...
                                    <div class="material-header">
                                        ...
                                        <div class="material-actions">
                                            @if (auth()->id() === $class->mentor_id && auth()->user()->role === 'mentor')
                                                <a href="{{ route('materials.edit', $material->id) }}" class="btn-edit" title="Edit Materi">
                                            ...
                                            @else
                                                <a href="{{ route('materials.show', $material->id) }}" class="btn-study">
                    ...
                    @else
                        ...
                        <div class="empty-state">
                            ...
                            <p class="empty-text">Belum ada materi yang tersedia untuk kelas ini. Silakan tunggu mentor menambahkan materi pembelajaran.</p>
